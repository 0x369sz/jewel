...
public final class PlatformInfo {
	...
	/**
	 * Represents the major operating system types supported by the application.
	 */
	public enum OSType {
		WINDOWS("Windows"),
		LINUX("Linux"),
	 ...
	 * This method is primarily used for switch expressions and platform-specific logic.
	 *
	...
	/**
	 * Logs detailed system information using the configured logger.
	 */
