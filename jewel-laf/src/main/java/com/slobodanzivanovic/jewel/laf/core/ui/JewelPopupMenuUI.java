...
/**
 * UI delegate for popup menus in the Jewel Look and Feel.
 * Customizes the appearance and behavior of JPopupMenu components.
 */
public class JewelPopupMenuUI extends BasicPopupMenuUI {
